        ...
        <section>
            <Element name="faq" className='relative'>
                <div className="container relative z-2 py-28">
                    ...
                    <div className='faq-line_after w-0.5 h-full absolute left-[calc(50%-1px)] top-10 -z-1 bg-s2' />
                </div>
                ...
                <div className='faq-glow_before relative z-2 border-2 border-s2 bg-s1'>
                    ...
                    <div className='faq-line_after absolute left-[calc(50%-1px)]
                    top-0 -z-1 h-full w-0.5 bg-s2 max-lg:hidden' />
                </div>
            </Element>
        </section>
    )
