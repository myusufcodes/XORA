        ...
        <section>
            <Element name="pricing">
                <div className="container">
                    ...
                    {/* pricing cards */}
                    <div className="scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-x-scroll max-xl:pt-6">
                                    ...
                                    <div className="relative z-2 flex items-center justify-center">
                                        <div className={clsx('h-num flex items-start', index === 1 ? 'text-p3' : 'text-p4')}>
                                            ...
                                            <CountUp
                                                ...
                                                to={monthly ? plan.priceMonthly : plan.priceYearly}
                                                separator=","
                                                direction="up"
                                                duration={0.4}
